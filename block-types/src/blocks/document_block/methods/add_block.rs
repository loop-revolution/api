...
use crate::blocks::document_block::{DocumentBlock, BLOCK_NAME};

impl DocumentBlock {
	pub fn add_block_method(
		context: &Context,
		block_id: i64,
		args: String,
...
impl DocumentBlock {
	pub fn build_add_block_action_object(block_id: i64) -> ActionObject {
		let method = MethodObject {
			block_type: BLOCK_NAME.into(),
			block_id: block_id.to_string(),
			method_name: "add_block".to_string(),
